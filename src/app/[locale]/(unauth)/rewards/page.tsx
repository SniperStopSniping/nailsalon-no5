  ...
  return (
    <PageLayout>
          ...
          {rewardApplied && (
            <div className="space-y-2 rounded-xl bg-[#fff7ec] p-3">
              <SummaryRow
                ...
                value={`$${appointmentDetails.originalPrice}`}
              />
              <SummaryRow
                label={t("reward_applied_label")}
                value={<span className="text-green-600">-${discountAmount}</span>}
              />
      ...
      <div className="space-y-3.5">
        <h2 className="text-base font-semibold text-neutral-900 px-1">
          {t("your_past_nails")}
        </h2>
        <div className="grid grid-cols-3 gap-2.5">
          {[
            ...
            <button
              ...
              className="aspect-square rounded-2xl bg-gradient-to-br from-[#f0dfc9] to-[#d9c6aa] hover:opacity-90 transition-opacity relative overflow-hidden shadow-sm"
            >
              <img
                src={photo.imageUrl}
                alt="Past nails"
